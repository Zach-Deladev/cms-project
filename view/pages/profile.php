                ...
                <div class="stat-grid">
                    <div id="record-post">
                        ...
                        <div class="record-cont">
                            ...
                            <?php echo "<h1 style='display: inline-block' > " . $_SESSION['wins'] .  "</h1>" ?>
                    ...
                    <div id="record-post">
                        ...
                        <div class="record-cont">
                            ...
                            <?php echo "<h1 style='display: inline-block' > " . $_SESSION['losses'] .  "</h1>" ?>
                    ...
                    <div id="record-post">
                        ...
                        <div class="record-cont">
                            ...
                            <?php echo "<h1 style='display: inline-block' > " . $_SESSION['draws'] .  "</h1>" ?>
                        </div>
                    </div>
                </div>
