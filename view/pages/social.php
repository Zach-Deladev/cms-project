    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div id="dashcontainer" class="col py-3">
                ...
                <form id="create-post" action="../../controller/formData/blog.php" method="post">
                    <h5>Create post</h5>
                    ...
                    <div id="content">
                        ...
                        <textarea rows="2" cols="33" type="text" name="content" placeholder="Content"> </textarea>
                    </div>
                    <div id="post-btn">
                ...
                <?php include '../displayAllBlogs.php'; ?>
            </div>
        </div>
    </div>
